...
function About() {
    return (
        ...
        <div className="About_DSC About"  >
            <img src={aboutdsc}
                 alt="aboutdsc.jpg" style={{boxShadow: "0px 0px 0px #ffe"}}/>
            <div>
                <p className="Abt_Heading">About DSC</p>
                <p className="Abt_Content">Google collaborates with university students who are passionate about growing developer
                 communities. DSC is one of the communities of Google where they provide resources to empower students and developers
                  to understand technologies and build solutions for real-world problems. Here one
                   can organize various Workshops, Hackathons, Study jam sessions, Bootcamps, Project-Building activities etc.
                 you can hone your skills by helping the local community resolve their daily difficulties.</p>
                <button>
        ...
        <div className="About About_DSC_IIITA" >
            ...
            <div>
                ...
                <p className="Abt_Content">Google Developer Students Club IIITA is a community for the students 
                of Indian Institute of Information Technology, Allahabad to help fine-tune their skills
                 and build applications that solve various campus and local problmes. <br></br><br></br>
The club is intended as a space for students to try out new ideas and collaborate to solve mobile,
 web development problems and as well as discover new heights in AI, ML, Designing and much more.</p>
                <button>
